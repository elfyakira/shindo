  ...
  return (
    <section className="relative h-[50vh] min-h-[400px] flex items-center">
      ...
      <div className="relative z-10 w-full px-6 lg:px-[10%]">
        <h1 className="text-[32px] lg:text-[48px] font-bold text-white mb-2">Cases</h1>
        <p className="text-sm text-white/80 tracking-wider">施工実績</p>
      </div>
    </section>
  );
}
          ...
          {ALL_CASES.map((item, index) => (
            <FadeInUp key={index} delay={index * 0.03}>
              <div className="group">
                ...
                <p className="text-[13px] lg:text-[14px] text-text-primary mt-3 leading-[1.6]">
                  {item.title}
                </p>
              </div>
            </FadeInUp>
